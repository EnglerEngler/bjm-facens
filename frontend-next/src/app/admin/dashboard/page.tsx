...
export default function AdminDashboardPage() {
  ...
  return (
    <main>
      ...
      <p className="muted">Clinicas registradas, medicos e pacientes por clinica.</p>
      ...
      <section className="card">
        <label htmlFor="admin-search">Pesquisar clinica, medico ou paciente</label>
        <input
          id="admin-search"
          value={query}
          onChange={(event) => setQuery(event.target.value)}
          placeholder="Ex.: Clinica Central, maria@, doctor_..."
        />
      </section>
