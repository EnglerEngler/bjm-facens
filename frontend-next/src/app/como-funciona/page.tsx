...
export default function ComoFuncionaPage() {
  return (
    <main className="story-main">
      <section className="story-panel story-hero">
        <div className="story-hero-grid">
          <div className="story-hero-copy">
            ...
            <p>
              O objetivo é simples: reduzir risco clínico, dar mais previsibilidade para a decisão médica e aumentar a
              segurança do tratamento.
            </p>
            <div className="story-intro-actions">
              <Link className="story-btn" href="/login">
                Acessar plataforma
              </Link>
            </div>
          </div>
          <aside className="story-hero-side">
      ...
      <section className="story-panel">
        ...
        <div className="story-flow-grid">
          ...
          <article className="story-flow-card">
            ...
            <p>
              A decisão continua sendo do médico, com justificativas e histórico auditável para continuidade do cuidado
              e revisão clínica futura.
            </p>
          </article>
        </div>
      </section>
      ...
      <section className="story-panel story-actions">
        ...
        <p>
          Para o médico, a plataforma melhora a confiança no momento de prescrever, com suporte objetivo para decisões
          de risco.
        </p>
        <p>
          Para o paciente, aumenta a segurança terapêutica, reduz a chance de condutas incompatíveis com o histórico
          clínico e fortalece a continuidade do cuidado.
        </p>
      </section>
    </main>
  );
